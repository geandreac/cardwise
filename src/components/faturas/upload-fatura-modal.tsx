      ...
      <div className="relative w-full max-w-md rounded-2xl border border-white/[0.08] bg-[#0f172a] p-6 shadow-2xl">
        ...
        {status === "success" && result ? (
          ...
          <>
            {/* Seleção de cartão */}
            <div className="mb-4">
              <label className="block text-xs font-medium text-slate-400 mb-1.5">Cartão</label>
              <select
                value={selectedCard}
            ...
            <div
              ...
              className="relative flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-slate-800 bg-slate-900/50 py-10 cursor-pointer hover:border-slate-700 hover:bg-slate-900 transition-colors mb-4"
            >
              <input
                ref={inputRef}
                type="file"
